...
template<>
InputParameters validParams<InjectionPeekConstantBC>()
{
...
InjectionPeekConstantBC::InjectionPeekConstantBC(const InputParameters & parameters) :
...
Real
InjectionPeekConstantBC::computeQpResidual()
{
...
Real
InjectionPeekConstantBC::computeQpJacobian()
{
  return _p*_phi[_j][_qp]*_test[_i][_qp];
}

Real
InjectionPeekConstantBC::computeQpOffDiagJacobian(unsigned int jvar)
{
  Real _E0;
