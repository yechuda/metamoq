...
template<>
InputParameters validParams<FaresSchroder88Full>()
{
...
FaresSchroder88Full::FaresSchroder88Full(const InputParameters & parameters) :
  Kernel(parameters),
...
Real FaresSchroder88Full::computeQpResidual()
{
  // convection part
...
Real FaresSchroder88Full::computeQpJacobian()
{
  // convection part
  RealVectorValue U(_u_vel[_qp], _v_vel[_qp], _w_vel[_qp]);
...
Real FaresSchroder88Full::computeQpOffDiagJacobian(unsigned jvar)
{
