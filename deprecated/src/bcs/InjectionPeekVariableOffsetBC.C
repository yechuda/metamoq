...
template<>
InputParameters validParams<InjectionPeekVariableOffsetBC>()
{
...
InjectionPeekVariableOffsetBC::InjectionPeekVariableOffsetBC(const InputParameters & parameters) :
...
Real
InjectionPeekVariableOffsetBC::computeQpResidual()
{
...
Real
InjectionPeekVariableOffsetBC::computeQpJacobian()
{
  return _p*_phi[_j][_qp]*_test[_i][_qp];
}

Real
InjectionPeekVariableOffsetBC::computeQpOffDiagJacobian(unsigned int jvar)
{
  Real _E0;
  Real _r0 = _q_point[_qp](_r_axis);
