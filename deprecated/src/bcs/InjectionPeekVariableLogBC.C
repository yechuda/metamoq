...
InjectionPeekVariableLogBC::InjectionPeekVariableLogBC(const InputParameters & parameters) :
...
Real InjectionPeekVariableLogBC::computeQpResidual()
{
...
Real InjectionPeekVariableLogBC::computeQpJacobian()
{
  return _p * std::exp(_u[_qp]) * _phi[_j][_qp] * _test[_i][_qp];
}

Real InjectionPeekVariableLogBC::computeQpOffDiagJacobian(unsigned int jvar)
{
  Real _E0;
  Real _r0 = _q_point[_qp](_r_axis);
